...
<div class="wrapper">
        ...
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
              <img class="navbar-logo" src="assets/img/solarus-logo-white-on-transparent.png" alt="Solarus">
            </a>
      ...
      <div class="row">
        ...
        <div class="col-sm-5">
          ...
          <div class="hero-right-column">
            ...
            <img class="hero-logo" src="assets/img/solarus-logo-white-on-transparent.png" alt="Solarus">

            <p class="lead">
              <b>Solarus is a free and open-source 2D Action-RPG game engine</b>,
              licensed under GPL, and written in C++.
              It runs quests in Lua, and can work on a great number of platforms.
              <br>
              Solarus also features a game editor called <b>Solarus Quest Editor</b>,
              written in C++ with Qt to help you creating your game.
            </p>
  ...
  <!-- div to push footer to the bottom -->
  <div class="push"></div>
</div> <!-- wrapper ->
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3">
          ...
          <p><b>© 2011-2015 Christopho.</b> Solarus
